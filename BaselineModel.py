...
def main(spark, netID):
    ...
    ratings = spark.read.csv('hdfs:/user/{netID}/train_small_data.csv', schema='userId INT, movieId INT, rating DOUBLE, timestamp INT') # TODO timestamep type
    ...
    ratings_val = spark.read.csv('hdfs:/user/{netID}/val_small_data.csv', schema='userId INT, movieId INT, rating DOUBLE, timestamp INT') # TODO timestamep type
    ...
    ratings_test = spark.read.csv('hdfs:/user/{netID}/test_small_data.csv', schema='userId INT, movieId INT, rating DOUBLE, timestamp INT') # TODO timestamep type
